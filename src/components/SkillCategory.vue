<template>
  <div class="skill-category">
    ...
    <div
      ...
      <div v-for="(skill, index) in skills" :key="index" :ref="(el) => {
        ...
        <div class="bg-white dark:bg-white/90 p-5 rounded-lg mb-2 sm:mb-3 md:mb-4">
          <img :src="skill.icon" :alt="skill.name" class="h-12 w-12 sm:h-16 sm:w-16 md:h-20 md:w-20 object-contain" />
        </div>
